...
export class AusbildungError extends Error {
 ...
 * userinfo redacted) and the message names it.
 */
export class AusbildungApiError extends AusbildungError {
...
export class AusbildungNetworkError extends AusbildungError {}
